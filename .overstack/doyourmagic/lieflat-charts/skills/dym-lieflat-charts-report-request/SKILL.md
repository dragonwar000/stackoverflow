---
name: dym-lieflat-charts-report-request
description: "Xin báo cáo nguyên trang (R01–R12). khi bạn cần một trang HTML hoàn chỉnh có tiêu đề, dẫn nhập, KPI, nhiều ô biểu đồ và nguồn — không phải vài cái hình rời."
disable-model-invocation: true
---

# Skill: dym-lieflat-charts-report-request — Xin báo cáo nguyên trang (R01–R12)
