---
name: dym-lieflat-charts-browse-templates
description: "Xem tận mắt kho template. biết trong kho có gì thì hỏi agent trúng hơn nhiều, và bạn tự đối chiếu được sản phẩm nhận về có đúng "cùng một nhà" với template không (checklist §8 câu 14)."
