---
name: dym-lieflat-charts-ci-example
description: "CI tối thiểu cho fork của bạn. repo gốc không có CI (ls .github → không tồn tại). Nếu bạn fork và sửa template, đây là mức tự động hoá nhỏ nhất đáng có."
disable-model-invocation: true
---

# Skill: dym-lieflat-charts-ci-example — CI tối thiểu cho fork của bạn
