---
name: dym-scientific-agent-skills-dung-skill-trong-agent
description: "Dùng skill trong agent (CHỈ prompt, không phải lệnh shell). skill đã cài rồi vẫn có thể không được agent chọn, hoặc chọn nhầm skill anh em. File này là cách gọi trúng, và cách viết prompt để agent chạy được nhiều bước."
disable-model-invocation: true
---

# Skill: dym-scientific-agent-skills-dung-skill-trong-agent — Dùng skill trong agent (CHỈ prompt, không phải lệnh shell)
