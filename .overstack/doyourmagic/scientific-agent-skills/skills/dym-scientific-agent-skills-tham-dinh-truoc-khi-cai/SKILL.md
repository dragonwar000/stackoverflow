---
name: dym-scientific-agent-skills-tham-dinh-truoc-khi-cai
description: "Thẩm định một skill TRƯỚC khi cài. Agent Skill là chỉ dẫn mà agent của bạn sẽ tuân theo — nó có thể bảo agent chạy code tuỳ ý, cài package, gọi mạng, sửa file. Repo này nhận đóng góp cộng đồng và tự nói thẳng là không đảm bảo đã soát hết. Đây là bước bắt "
disable-model-invocation: true
---

# Skill: dym-scientific-agent-skills-tham-dinh-truoc-khi-cai — Thẩm định một skill TRƯỚC khi cài
