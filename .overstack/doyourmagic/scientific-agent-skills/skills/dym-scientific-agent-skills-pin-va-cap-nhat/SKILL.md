---
name: dym-scientific-agent-skills-pin-va-cap-nhat
description: "Ghim version, cập nhật, gỡ bỏ. skill là chỉ dẫn mà agent tuân theo. Một bản cập nhật thầm lặng đổi hành vi agent giữa hai lần chạy — đúng thứ bạn không muốn trong một phân tích cần tái lập. File này khoá version và làm cho việc nâng cấp thành một hành"
disable-model-invocation: true
---

# Skill: dym-scientific-agent-skills-pin-va-cap-nhat — Ghim version, cập nhật, gỡ bỏ
