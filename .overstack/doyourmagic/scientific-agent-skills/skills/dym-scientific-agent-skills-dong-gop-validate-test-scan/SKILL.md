---
name: dym-scientific-agent-skills-dong-gop-validate-test-scan
description: "Đóng góp: validate, test, scan. đây là các cổng CI thật. Chạy trước là biết PR đỏ ở đâu trong vài giây thay vì chờ vòng CI."
disable-model-invocation: true
---

# Skill: dym-scientific-agent-skills-dong-gop-validate-test-scan — Đóng góp: validate, test, scan
