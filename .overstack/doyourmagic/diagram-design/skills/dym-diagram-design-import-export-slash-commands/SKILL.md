---
name: dym-diagram-design-import-export-slash-commands
description: "Slash command: import và export (gõ trong chat). đây là bề mặt bạn dùng hằng ngày. Năm slash command là wrapper mỏng — mỗi cái ủy quyền cho một file trong references/ làm nguồn chân lý, và tự nhắc "đừng cài lại logic ở đây"."
