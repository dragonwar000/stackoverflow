---
name: dym-diagram-design-install-and-verify
description: "Cài đặt và chứng minh nó chạy. Diagram Design là một plugin/agent-skill, không phải package npm hay pypi — không có npm install, không có pip install, không có binary. Cài sai đường là skill không bao giờ được nạp và bạn sẽ ngồi chờ một cái gì đó khôn"
disable-model-invocation: true
---

# Skill: dym-diagram-design-install-and-verify — Cài đặt và chứng minh nó chạy
