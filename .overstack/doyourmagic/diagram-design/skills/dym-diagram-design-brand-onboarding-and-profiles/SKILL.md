---
name: dym-diagram-design-brand-onboarding-and-profiles
description: "Onboard brand và quản lý profile khách hàng. sơ đồ đầu tiên trong một dự án mới sẽ bị chặn bởi một cổng bắt buộc. Skill từ chối im lặng xuất sơ đồ mang màu mặc định vào một dự án có brand. Không biết cổng này thì bạn tưởng agent bị treo."
disable-model-invocation: true
---

# Skill: dym-diagram-design-brand-onboarding-and-profiles — Onboard brand và quản lý profile khách hàng
