---
name: dym-archify-repository-evidence
description: "Sơ đồ architecture gắn bằng chứng mã nguồn thật. khi sơ đồ kiến trúc phải chứng minh được nó phản ánh mã thật, không phải trí nhớ của ai đó. Node có bằng chứng tự đánh dấu SRC n trong viewer và mở đúng file + khoảng dòng, ghim vào một commit công khai."
