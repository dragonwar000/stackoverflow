---
name: dym-archify-cli-authoring-loop
description: "Vòng lặp soạn sơ đồ bằng CLI trong terminal. khi bạn tự viết JSON IR (hoặc kịch bản hoá việc sinh sơ đồ) và không muốn qua agent. CLI là zero-dependency, chạy được ngay trên cây nguồn sạch."
disable-model-invocation: true
---

# Skill: dym-archify-cli-authoring-loop — Vòng lặp soạn sơ đồ bằng CLI trong terminal
