---
name: dym-archify-agent-chat-authoring
description: "Soạn sơ đồ từ khung chat của agent. đây là đường dùng chính của Archify. Bạn mô tả hệ thống bằng ngôn ngữ tự nhiên, agent tự chọn loại sơ đồ, tự viết JSON IR theo schema, tự chạy validate/deliver, rồi trả về đường dẫn HTML."
disable-model-invocation: true
---

# Skill: dym-archify-agent-chat-authoring — Soạn sơ đồ từ khung chat của agent
