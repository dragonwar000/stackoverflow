---
name: dym-arex-skill-contributor-dong-gop-skill
description: "Contributor: đóng góp / refresh một repo skill vào thư viện. Bạn muốn thêm repo vào bộ 1.000, hoặc cập nhật một skill đã cũ so với upstream."
disable-model-invocation: true
---

# Skill: dym-arex-skill-contributor-dong-gop-skill — Contributor: đóng góp / refresh một repo skill vào thư viện
