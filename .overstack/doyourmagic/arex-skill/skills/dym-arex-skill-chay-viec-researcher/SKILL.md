---
name: dym-arex-skill-chay-viec-researcher
description: "Chạy việc nghiên cứu ở Researcher mode (shell). Đây là đường dùng chính hằng ngày — giao một mục tiêu nghiên cứu cụ thể, để router chọn skill và agent tự chạy + tự kiểm chứng."
disable-model-invocation: true
---

# Skill: dym-arex-skill-chay-viec-researcher — Chạy việc nghiên cứu ở Researcher mode (shell)
