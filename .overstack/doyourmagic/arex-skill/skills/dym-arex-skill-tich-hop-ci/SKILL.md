---
name: dym-arex-skill-tich-hop-ci
description: "Ghim & gác thư viện skill trong CI của **dự án bạn**. Kết quả nghiên cứu chỉ tái lập được nếu cùng một bộ skill. Thư viện đổi âm thầm là kết quả cũ không giải thích được nữa."
disable-model-invocation: true
---

# Skill: dym-arex-skill-tich-hop-ci — Ghim & gác thư viện skill trong CI của **dự án bạn**
