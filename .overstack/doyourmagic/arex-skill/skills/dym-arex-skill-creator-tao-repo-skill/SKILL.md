---
name: dym-arex-skill-creator-tao-repo-skill
description: "Creator: tạo / verify / refresh / extend một repo skill. Repo bạn cần chưa có trong thư viện 1.000 skill, hoặc skill có sẵn đã lệch so với upstream."
disable-model-invocation: true
---

# Skill: dym-arex-skill-creator-tao-repo-skill — Creator: tạo / verify / refresh / extend một repo skill
