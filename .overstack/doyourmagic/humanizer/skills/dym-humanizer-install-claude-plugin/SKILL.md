---
name: dym-humanizer-install-claude-plugin
description: "Cài Humanizer làm plugin Claude Code (lệnh chat). đường này không đụng terminal và không đẻ file nào trong repo dự án. Đổi lại nó chỉ chạy trên Claude Code."
disable-model-invocation: true
---

# Skill: dym-humanizer-install-claude-plugin — Cài Humanizer làm plugin Claude Code (lệnh chat)
