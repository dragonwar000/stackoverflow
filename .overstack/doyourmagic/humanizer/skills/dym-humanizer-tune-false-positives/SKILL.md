---
name: dym-humanizer-tune-false-positives
description: "Chặn sửa quá tay: false positive và chi tiết người cần giữ. rủi ro lớn nhất của Humanizer không phải sửa thiếu, mà sửa quá tay — bào mất giọng thật, gỡ mất một disclaimer pháp lý, hay viết lại một câu trích dẫn. SKILL.md có sẵn hai hàng rào cho việc này; file này chỉ ra cách gọi "
disable-model-invocation: true
---

# Skill: dym-humanizer-tune-false-positives — Chặn sửa quá tay: false positive và chi tiết người cần giữ
