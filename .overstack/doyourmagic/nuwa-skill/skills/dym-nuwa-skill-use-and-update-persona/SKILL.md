---
name: dym-nuwa-skill-use-and-update-persona
description: "Dùng và cập nhật một persona skill (chat-only). Vì sao dùng: skill đã chắt lọc xong nằm im thì vô dụng — file này nói cách gọi nó ra làm việc, cách kéo nó ra khỏi vai, và cách làm mới nó khi tư liệu đã cũ."
disable-model-invocation: true
---

# Skill: dym-nuwa-skill-use-and-update-persona — Dùng và cập nhật một persona skill (chat-only)
