---
name: dym-nuwa-skill-publish-and-get-listed
description: "Phát hành skill của bạn và xin thu vào COMMUNITY.md. Vì sao dùng: skill bạn chắt lọc ra là tài sản của bạn — repo nüwa không nhận persona skill vào examples/; đường chính thức là bạn tự host repo riêng (star về bạn) rồi thêm một dòng vào chỉ mục cộng đồng."
disable-model-invocation: true
---

# Skill: dym-nuwa-skill-publish-and-get-listed — Phát hành skill của bạn và xin thu vào COMMUNITY.md
