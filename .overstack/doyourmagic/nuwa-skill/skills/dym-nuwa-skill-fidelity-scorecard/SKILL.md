---
name: dym-nuwa-skill-fidelity-scorecard
description: "Chấm bảo chân (Fidelity Scorecard) cho skill vừa làm ra. Vì sao dùng: đây là "kiểm định xuất xưởng" — thứ duy nhất trong repo có thể nói skill của bạn giống người thật đến đâu, và là điều kiện cứng để được thu vào COMMUNITY.md."
